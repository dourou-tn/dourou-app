<template>
  <div class="text-center flex flex-col	items-center justify-center">
      ...
      <!-- comingsoon-title text-white text-4xl md:text-6xl lg:text-7xl xl:text-8xl mb-15 font-bold -->
      <!-- title & subtitle -->
      <div class="px-2">
        <h2 class="
        ">
        ...
        <div
          class="
            bg-red-500 sm:bg-green-500 md:bg-blue-500 lg:bg-purple-500 xl:bg-orange-500 2xl:bg-orange-500
             h-1
          "
        />
